...
class Dataset:
    ...
    def from_schema(cls, schema: Path|str, out_loc: Path|str, gdb_name: str, 
        ...
        Args:
            ...
            skip_rules (bool): Don't import Attribute Rules after building the new dataset (default: False)
        ...
        with TemporaryDirectory(f'{gdb_name}_json_schema') as tmp:
            ...
            if not skip_rules:
                ds.import_rules(tmp / 'rules', skip_fail=skip_fail)
        return ds
